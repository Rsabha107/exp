@if (Auth::user()->hasRole('VenueAdminxx'))
    {{ logger()->info('User is VenueAdmin') }}
    @extends('sps.venue-admin.layout.template')
@elseif (Auth::user()->hasRole('Operator'))
    {{ logger()->info('User is Operator') }}
...
@section('main')
        ...
        <div>
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb breadcrumb-style1">
                    ...
                    <li class="breadcrumb-item"><a href="{{ route('sps.users.profile') }}">
                            ...
                            <div class="card-body p-4">
                                ...
                                <div class="tab-content pt-4" id="profileTabContent">
                                    <div class="tab-pane fade show active" id="profile-tab-pane" role="tabpanel"
                                        ...
                                        <form action="{{ route('sps.users.profile.update') }}" method="POST"
                                            enctype="multipart/form-data" class="row gy-3 gy-xxl-4 needs-validation"
                                            novalidate>
                                            @csrf
                                    ...
                                    <div class="tab-pane fade" id="password-tab-pane" role="tabpanel"
                                        ...
                                        <form action="{{ route('sps.users.profile.password.update') }}" method="POST"
                                            enctype="multipart/form-data" class="row gy-3 gy-xxl-4 needs-validation"
                                            novalidate>
                                            @csrf
    ...
    {{-- @include('sps.modals.booking_modals') --}}
@endsection
