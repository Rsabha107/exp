...
<nav class="navbar navbar-top fixed-top navbar-expand" id="navbarDefault">
    <div class="collapse navbar-collapse justify-content-between">
        <div class="navbar-logo">
            ...
            <a class="navbar-brand me-1 me-sm-3" href="{{ route('chl.admin.tasks.index') }}">
        ...
        @php
            ...
            $user_events = auth()->user()->events->where('active_flag', 1)->sortBy('name');
        @endphp
                            ...
                            <div class="scrollbar-overlay" style="height: 27rem;">
                                @foreach ($user_events as $event)
                                    ...
                                    @else
                                        ...
                                        @endphp
                                    @endif
                                    <a href="{{ route('chl.venue.admin.orders.switch', $event->id) }}"
                            ...
                            {{-- <div class="overflow-auto scrollbar" style="height: 10rem;">
                                <ul class="nav d-flex flex-column mb-2 pb-1">
                                    <li class="nav-item"><a class="nav-link px-3 d-block"
                                            href="{{ route('sps.users.profile') }}"> <span
