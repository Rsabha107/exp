...
<body class="nav-slim">
    ...
    <main class="main" id="top">
        ...
        {{-- <x-sps.venue-admin.sidemenu /> --}}
        @include('sps.venue-admin.body.header')

        {{-- // start of content --}}
        <div class="content">
            @yield('main')
            @include('sps.venue-admin.partials.labels')
            @include('sps.venue-admin.body.footer')
        </div>
        {{-- // end of content --}}
    ...
    <script src="{{ asset('assets/js/pages/sps/spinner/spin.js') }}"></script>
