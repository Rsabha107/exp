            ...
            <ul class="navbar-nav flex-column" id="navbarVerticalNav">
                ...
                <li class="nav-item">
                    ...
                    <div class="nav-item-wrapper"><a class="nav-link dropdown-indicator  label-1" href="#nv-MDS"
                        ...
                        <div class="parent-wrapper label-1">
                            <ul class="nav collapse parent {{ Request::is('/sps/venue-admin') ? 'show' : '' }}"
                            ...
                            <ul class="nav collapse parent {{ Request::is('/sps/venue-admin/find') ? 'show' : '' }}"
                                ...
                                <li class="nav-item"><a
                                        ...
                                        <div class="d-flex align-items-center"><span
                                                class="nav-link-text">Cehck-in/Check-out</span>
                                        </div>
                                    </a>
                                </li>
                            </ul>
                             <div class="nav-item-wrapper">
                                    <a class="nav-link label-1 {{ Request::is('sps/user/tasks') ? 'active' : '' }}"
                                        href="{{ route('sps.user.tasks.index') }}" role="button" data-bs-toggle=""
                                        aria-expanded="false">
                                        <div class="d-flex align-items-center"><span class="nav-link-icon"><span
                                                    data-feather="compass"></span></span><span
                                                class="nav-link-text-wrapper"><span class="nav-link-text">Tasks</span></span>
                                        </div>
                                    </a>
                                </div>
                        </div>
