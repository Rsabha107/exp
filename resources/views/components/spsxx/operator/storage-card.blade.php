        ...
        <div class="table-responsive text-nowrap">
            ...
            <div class="mx-2 mb-2">
                <table id="storage_table"
                    ...
                    data-url="{{ route('sps.operator.list')}}"
...
//     function refNumberFormatter(value, row) {

//     let plainRef = $('<div>').html(value).text(); //jquery to strip html
//     return `<a href="/sps/operator/find_direct/${plainRef}" class="ref-link">
//                 ${plainRef}
//             </a>`;
// }    
</script>