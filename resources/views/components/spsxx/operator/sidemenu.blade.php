            ...
            <ul class="navbar-nav flex-column" id="navbarVerticalNav">
                    ...
                    <div class="nav-item-wrapper"><a class="nav-link dropdown-indicator label-1" href="#nv-home"
                        ...
                        <div class="parent-wrapper label-1">
                            <ul class="nav collapse parent" data-bs-parent="#navbarVerticalCollapse" id="nv-home">
                                ...
                                <li class="nav-item"><a class="nav-link" href="{{ route('sps.admin.dashboard') }}">
                ...
                <li class="nav-item">
                    ...
                    <div class="nav-item-wrapper"><a class="nav-link dropdown-indicator  label-1" href="#nv-MDS"
                        ...
                        <div class="parent-wrapper label-1">
                            <ul class="nav collapse parent {{ Request::is('/sps/operator') ? 'show' : '' }}"
                                data-bs-parent="#navbarVerticalCollapse" id="nv-MDS">
                                <li class="collapsed-nav-item-title d-none">SPS Storage
                                </li>
                                <li class="nav-item"><a class="nav-link {{ Request::is('/sps/operator') ? 'active' : '' }}"
                                        href="{{ route('sps.operator') }}">
                                        <div class="d-flex align-items-center"><span
                            ...
                            <!-- <ul class="nav collapse parent {{ Request::is('/sps/operator/find_direct/0') ? 'show' : '' }}"
                                data-bs-parent="#navbarVerticalCollapse" id="nv-MDS">
                                <li class="collapsed-nav-item-title d-none">SPS Storage
                                </li>
                                <li class="nav-item"><a
                                        class="nav-link {{ Request::is('/sps/operator/find_direct/0') ? 'active' : '' }}"
                                        href="{{ route('sps.operator.find') }}">
                                        <div class="d-flex align-items-center"><span
                                                class="nav-link-text">Check-in/out</span>
                                        </div>
                                    </a>
                                </li>
                            </ul> -->
