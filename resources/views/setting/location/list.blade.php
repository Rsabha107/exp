...
{{-- <div class="content"> --}}
    {{-- <div class="container-fluid"> --}}
                ...
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb breadcrumb-style1">
                        ...
                        <li class="breadcrumb-item active">
                            <?= get_label('location', 'Venues') ?>
                        </li>
                    </ol>
                </nav>
            </div>
            <div>
                <x-button_insert_modal bstitle='Add Venue' bstarget="#create_locations_modal" />
        ...
        <x-settings.location-card />
    {{-- </div> --}}

    @include('setting.modals.location_modals')
    <script>
    ...
    <script src="{{asset('assets/js/pages/setting/location.js')}}"></script>
    @endsection
