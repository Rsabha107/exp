...
<script src="{{ asset('assets/js/pages/sps/venue-admin/status_list_update.js') }}"></script>
...
<script>
    ...
    $('.editable').on('blur', function() {
        ...
        $.ajax({
            url: '/sps/venue-admin/item/update-field/' + id,
            method: 'POST',
            data: {
                _token: '{{ csrf_token() }}',
                field: field,
                        ...
                        <tr>
                            ...
                            <td
                                ...
                                <select class="form-select select2-status mx-auto" data-id="{{ $item->id }}"
                                    data-url="{{ route('sps.venue.admin.item.update.status') }}">
