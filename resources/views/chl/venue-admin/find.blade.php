...
@section('main')
    {{-- <div class="container"> --}}
    <form method="POST" action="{{ route('sps.venue.admin.get') }}" class="forms-sample needs-validation" novalidate=""
        id="visitor_form">
        @csrf
            ...
            <div class="col-sm-10 col-md-8 col-lg-10 col-xl-10 col-xxl-12">
                <div class="card shadow-sm mb-3">
                    ...
                    <div class="row flex-between-center mb-5">
                        ...
                        {{-- <div class="col-auto">
                            <a class="fs-9 fw-semibold me-5" href="{{ route('sps.venue.admin') }}">Back to Admin</a>
                        </div> --}}
                    </div>
                </div>
    ...
    <script src="{{ asset('assets/js/pages/sps/venue-admin/find.js') }}"></script>
