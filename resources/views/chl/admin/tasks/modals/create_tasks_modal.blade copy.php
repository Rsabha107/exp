...
<div class="modal fade" id="createTaskModal" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <form id="form_submit_event" class="form-submit-event" action="{{ route('sps.admin.tasks.store') }}" method="POST">
                @csrf
                ...
                <div class="modal-body">
                    ...
                    <div class="mb-3">
                        ...
                        <select name="status_id" class="form-select">
                            ...
                            @foreach($todo_statuses as $status)
                    ...
                    <div class="mb-3">
                        ...
                        <select name="status_color_id" class="form-select">
