                    ...
                    <div class="col-12 col-xl-10 col-xxl-8">
                        <div class="row justify-content-center align-items-center g-5">
                            ...
                            <div class="col-12 col-lg-6 text-center">
                                ...
                                <h1 class="display-4 text-warning">⚠️ Warning</h1>
                                <p class="lead mt-3 text-white">{{ $message ?? 'Something went wrong.' }}</p>

                                {{-- @endhasrole --}}
                                {{-- <a class="btn btn-lg btn-secondary w-100" href="{{ route('mds.customer') }}">Request
                                    Access</a> --}}
                            </div>
                        </div>
                    </div>
