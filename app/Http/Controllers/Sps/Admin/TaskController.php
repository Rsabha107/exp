...
class TaskController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('sps.admin.tasks.index', compact('categories', 'venues', 'events'));
    }
    ...
    public function create()
    {
        ...
        return view('sps.admin.tasks.create', compact('categories'));
    }
    ...
    public function edit(Task $task)
    {
        ...
        return view('sps.admin.tasks.edit', compact('task', 'categories'));
    }
    ...
    public function copyToLead(Request $request)
    {
        try {
            ...
            LeadTask::where('venue_id', $venueId)->where('event_id', $eventId)->delete();
            LeadCategory::where('venue_id', $venueId)->where('event_id', $eventId)->delete();
    ...
    public function pickEvent(Request $request)
    {
        ...
        if ($request->event_id && $request->venue_id) {
            ...
            return redirect()->route('chl.admin')->with('message', 'Event/Venue Switched.');
        }
        //  else {
        // return back()->with('error', 'Workspace not found.');
        Log::info('event_id is null');
        return redirect()->route('chl.admin')->with('error', 'Event not found.');
        // }
    }
}
